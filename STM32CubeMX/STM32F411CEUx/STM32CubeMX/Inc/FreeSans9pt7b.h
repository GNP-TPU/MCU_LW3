#ifndef FreeSans9pt_H
#define FreeSans9pt_H

#include <stdio.h>
#include <stdint.h>

typedef struct {
    uint16_t bitmapOffset; // Смещение в байтах внутри FreeSans9pt7bBitmaps
    uint8_t  width;        // Ширина матрицы буквы в пикселях
    uint8_t  height;       // Высота матрицы буквы в пикселях
    uint8_t  xAdvance;     // На сколько пикселей сдвинуть курсор вправо
    int8_t   dX;           // Смещение пикселей по X
    int8_t   dY;           // Смещение пикселей по Y
} GFXglyph;
...
static const GFXglyph FreeSans9pt7bGlyphs[] = {
    ...
    {567, 13, 13, 15, 1, -12}, // 0x4F 'O'
    {589, 10, 13, 11, 1, -12}, // 0x50 'P'
    {606, 13, 14, 14, 1, -12}, // 0x51 'Q'
    {629, 12, 13, 13, 1, -12}, // 0x52 'R'
    {649, 10, 13, 11, 1, -12}, // 0x53 'S'
